		...
		switch (curCharacter)
		{
			...
			*/
			...
			if (PlayState.SONG.song != '')
			{
				...
				animation.addByPrefix('idle', 'Ace IDLE', 6); //With afterimage trail (6 frames for idle/12 frames for others)
			...
			case 'cb':
				...
				addOffset('singDOWN', -120, 18);
				addOffset('singLEFT', -29, 16);
				addOffset('singUP', -38, 199);
